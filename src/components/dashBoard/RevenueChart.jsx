...
export default function RevenueChart({
    ...
    subtitle = "Monthly earnings with growth projection",
    colorTheme = "copper"
}) {
    // Define themes
    const themes = {
    ...
    return (
        <div className="lg:col-span-2 glass-panel p-lg rounded-xxl space-y-lg h-[400px] flex flex-col">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center bg-surface-container-low rounded-lg p-1 border border-outline-variant/10">
                    <button className="px-4 py-1.5 rounded-md bg-primary-container text-on-primary-container text-xs font-bold">
                        12M
                    </button>
                    <button className="px-4 py-1.5 rounded-md text-on-surface-variant text-xs hover:text-primary transition-colors">
                        6M
                    </button>
                    <button className="px-4 py-1.5 rounded-md text-on-surface-variant text-xs hover:text-primary transition-colors">
                        3M
