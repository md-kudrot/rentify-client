            ...
            <div className="space-y-6">
                                    ...
                                    <tr key={booking.id} className="hover:bg-[#302823]/50 transition-colors group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0 border border-[#ffb77e]/20">
                                                    <img
                                        ...
                                        <td className="px-6 py-4 text-sm font-bold text-[#ffb77e]">{booking.amount}</td>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            {booking.status === "Pending" ? (
                                                <div className="flex items-center justify-end gap-2">
                                                    <button className="px-4 py-2 bg-green-500/10 text-green-400 text-xs font-bold rounded-lg hover:bg-green-500/20 transition-colors border border-green-500/20">
                                                        Approve
                                                    </button>
                                                    <button
                ...
                {isRejectModalOpen && selectedBooking && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4">
                        <div className="bg-[#19120d] border border-[#534438]/30 rounded-3xl w-full max-w-md overflow-hidden animate-fade-in shadow-2xl">
                            ...
                            <div className="p-6 space-y-4">
                                <p className="text-[#efe0d7]">
                                    ...
                                    <span className="font-bold text-[#ffb77e]">{selectedBooking.tenant}</span> for{" "}
                                    <span className="font-bold">{selectedBooking.property}</span>?
                                </p>
                                <div>
