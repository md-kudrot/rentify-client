...
export default function OwnerDashboard() {
  ...
  return (
    <DashboardLayout role="owner">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-md space-y-md">
            ...
            <div className="p-md bg-surface-container-low rounded-xl border border-outline-variant/5 hover:border-primary/20 transition-all cursor-pointer">
              ...
              <div className="flex gap-sm">
                <button className="flex-1 bg-primary text-on-primary font-bold text-xs py-2 rounded-lg hover:opacity-90 transition-all">Accept</button>
                <button className="flex-1 border border-outline-variant/30 text-on-surface-variant font-bold text-xs py-2 rounded-lg hover:bg-surface-container-high transition-all">Decline</button>
              </div>
            </div>
            ...
            <div className="p-md bg-surface-container-low rounded-xl border border-outline-variant/5 hover:border-primary/20 transition-all cursor-pointer">
              <div className="flex items-center gap-md mb-md">
                <div className="w-10 h-10 rounded-full overflow-hidden">
                  <img className="w-full h-full object-cover" alt="Marcus Sterling" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAPxA4Ln7tAUSX6hQzIkgHmqYNSpMnCYVyHNe2mnj2Ki7UpeYWrbs0rrJXdkKXlYfV18lrABNjJgXKKUbj0jSVw0E0JloSyiBMrCQQE5LtGZRmgt18BUUdMreAyoRpDPLF4LVylbcJtDgERT1KKBzTWhDyxNMo3dL9akEnKh_RvjBW0tm7Paa17AQT7tDOqHCgbGzcGjGLN6G06wwLOzVTv46hk6oc21MD0G4_xMJJfF31pLv9Nxn1GNecRyLaQrUrUVE-f-LW8Mc4"/>
                </div>
                <div className="flex-1">
      ...
      <section className="bg-slate-800/80 backdrop-blur-[24px] border border-slate-50/5 rounded-xxl overflow-hidden">
        <div className="p-lg border-b border-outline-variant/10 flex flex-col md:flex-row md:items-center justify-between gap-md">
          <div>
            ...
            <p className="text-on-surface-variant text-sm">Performance tracking for your luxury portfolio</p>
          </div>
          <div className="flex gap-sm">
            ...
            <button className="bg-gradient-to-br from-[#C97B36] to-[#F4A261] text-white px-6 py-2 rounded-lg text-sm font-bold hover:shadow-[0_0_25px_rgba(201,123,54,0.25)] hover:scale-105 transition-all">
              Add Property
            </button>
          </div>
        </div>
          ...
          <table className="w-full text-left whitespace-nowrap">
            ...
            <tbody className="divide-y divide-outline-variant/5">
              <tr className="hover:bg-surface-container-high/30 transition-colors group cursor-pointer active:scale-[0.98]">
                ...
                <td className="px-lg py-md">
                  <span className="px-2 py-1 rounded-full text-[10px] font-bold bg-tertiary-container/20 text-tertiary-fixed border border-tertiary/20">Available</span>
                </td>
                <td className="px-lg py-md">
