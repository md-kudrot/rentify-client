  ...
  return (
    <DashboardLayout role="tenant">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-lg mt-lg">
        {/* Payment History */}
        <div className="glass-panel rounded-xxl overflow-hidden flex flex-col min-h-[400px]">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-md space-y-md">
            {[1, 2, 3].map((item) => (
              <div key={item} className="p-md bg-surface-container-low rounded-xl border border-outline-variant/5 flex items-center justify-between">
        ...
        <div className="space-y-lg">
          <div className="glass-panel p-lg rounded-xxl space-y-md">
