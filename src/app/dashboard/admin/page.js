  ...
  return (
    <DashboardLayout role="admin">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-lg mt-lg">
        <RevenueChart data={chartData} title="Platform Volume" subtitle="Total transaction volume across all properties" colorTheme="blue" />
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-md space-y-md">
            <div className="p-md bg-error-container/10 rounded-xl border border-error/20 flex items-start gap-md">
               ...
               <div>
                 ...
                 <p className="text-[10px] text-on-surface-variant">Elevated response times detected in Stripe integration.</p>
               </div>
            </div>
            ...
            <div className="p-md bg-surface-container-low rounded-xl border border-outline-variant/5 flex items-start gap-md">
               ...
               <div>
                 ...
                 <p className="text-[10px] text-on-surface-variant">5 new luxury property owners joined today.</p>
               </div>
            </div>
            ...
            <div className="p-md bg-surface-container-low rounded-xl border border-outline-variant/5 flex items-start gap-md">
               ...
               <div>
                 ...
                 <p className="text-[10px] text-on-surface-variant">Maintenance window planned for Sunday 2AM EST.</p>
               </div>
            </div>
          </div>
        </div>
